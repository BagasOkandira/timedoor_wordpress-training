    ...
    <div class="row">
      ...
      <div class="col-lg-7 pe-5">
        <div class="contact__form">
          <?php echo do_shortcode('[contact-form-7 id="a9c7cf2" title="Contact form"]'); ?>
        </div>
      </div>
      <div class="col-lg-5 ps-5">
        <div class="contact__wrapper">
          <div class="contact__title"><?php echo esc_html(get_field('contact_title')); ?></div>
          ...
          <ul class="contact__list">
            ...
            <li class="contact__list-item">
              ...
              <a class="contact__list-link" href="<?php echo esc_url(get_field('contact_website')); ?>"
                target="_blank"><?php echo esc_html(get_field('contact_website')); ?></a>
            </li>
          </ul>
        </div>
      </div>
